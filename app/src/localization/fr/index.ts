const translation = {
  ...
  PINCreate: {
    ...
    Helper: {
      ...
      PINExpectedLengthValidation: 'Votre NIP doit contenir {{num}} chiffres.',
  ...
  Filters: {
    ...
    AppParamsChanged: "Modification des paramètres de l'application",
    ...
    ButtonApplyFilters: 'Appliquer',
    ButtonDeleteFilters: 'Effacer les filtres',
    ButtonClose: 'Fermer',
