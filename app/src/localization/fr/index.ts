const translation = {
  BCID: {
    GetID: 'Obtenir BCID',
    GetDigitalID: 'Ajouter [nom de l’attestation du SAG]',
  },
  Onboarding: {
    SkipA11y: 'Sauter',
  },
  ...
  Credentials: {
    ...
    EmptyList: 'Votre portefeuille ne contient aucune attestation. Vos attestations valides seront ajoutées ici.',
  ...
  OptionsPlus: {
    ...
    DetailSupport: 'Vous avez des questions ou un problème avec l’application ?',
  ...
  PINCreate: {
    ...
    EnterPINTitle: 'Veuillez saisir un NIP à six (6) chiffres',
    EnterPIN: 'Veuillez saisir un NIP à six (6) chiffres',
    ...
    NewPIN: 'nouveau',
    RememberChangePIN: 'Modifier votre NIP pour sécuriser votre portefeuille.',
    Message: {
      ...
      PINExpectedLengthValidation: 'Votre NIP doit contenir {{num}} chiffres. Veuillez choisir un nouveau NIP.',
    ...
    Helper: {
      ...
      NoRepetitionOfTheTwoSameNumbersValidation: 'Ne doit pas contenir de répétition de deux chiffres. (exemple: 1212)',
      MaxAdjacentNumberRepetitionValidation: 'Ne doit pas contenir de répétition. (exemple: 222)',
      NoRepetitionOfTheSameNumbersValidation: 'Ne doit pas contenir de répétition. (exemple: 222)',
      NoSeriesOfNumbersValidation: 'Ne doit pas contenir de série. (exemple: 123)',
      PINOnlyContainDigitsValidation: 'Doit contenir des chiffres seulement.',
      PINTooShortValidation: 'Votre NIP doit contenir plus que {{num}} chiffres.',
      PINTooLongValidation: 'Votre NIP doit contenir moins de {{num}} chiffres.',
      PINExpectedLengthValidation: 'Votre NIP doit contenir six ({{num}}) chiffres.',
  ...
  ContactDetails: {
    ...
    UnableToRemoveCaption:
      'Impossible de supprimer ce contact, car il y a des attestations émises par ce contact dans votre portefeuille. Supprimez d’abord les attestations, puis supprimez ce contact.',
    GoToCredentials: 'Accédez aux attestations',
    ContactRemoved: 'Contact supprimé',
    RemoveContactMessageTop: 'En supprimant ce contact, vous ne pourrez plus :',
    RemoveContactMessageBottom: 'Ce contact ne saura pas que vous l’avez supprimé.',
    RemoveContactsBulletPoint1: 'obtenir de nouvelles attestations de sa part.',
    RemoveContactsBulletPoint2: 'être informé des mises à jour de vos attestations liées à ce contact.',
    ...
    Credentials: 'Mes attestations avec ',
    NoCredentials: "Vous n'avez aucune attestation de ce contact.",
  },
  WhatAreContacts: {
    Title: "Qu'est-ce qu'un contact?",
    Preamble: 'L’ajout d’une organisation en tant que contact vous permettra de :',
    ListItemCredentialUpdates: '',
    ListItemNewCredentials: 'Être informé des mises à jour de vos attestations',
    ListItemProofRequest: '',
    ...
    ListItemDirectMessage: 'Obtenir de nouvelles attestations',
    ListItemNotifiedOfUpdates: '',
    ListItemRequest: '',
  },
  Contacts: {
    EmptyList: 'Votre portefeuille ne contient aucun contact. Vos nouveaux contacts seront ajoutés ici.',
    TypeHere: 'Saisissez votre message ici.',
    PeopleAndOrganizations: 'Les organisations avec lesquelles vous avez interagi s’affichent ici.',
  ...
  CredentialDetails: {
    ...
    RemoveCaption: 'Vous ne pourrez plus utiliser les informations de cette attestation dans le portefeuille.',
    ...
    YouWillNotLoseListItem1: 'Le contact de l’organisation qui a émise l’attestation.',
    YouWillNotLoseListItem2: '',
    HowToGetThisCredentialBack: 'Comment récupérer une attestation',
    HowToGetThisCredentialBackListItem1:
      'Vous devrez faire à nouveau la demande d’attestation auprès de l’organisation qui l’a émise.',
  },
  Home: {
    Welcome: 'Bonjour!',
  ...
  Scan: {
    ...
    WhatToScan: 'Quels codes QR peuvent être balayés ?',
  ...
  CredentialOffer: {
    ...
    CredentialOnTheWay: 'Votre attestation est en cours de réception',
    ...
    Declined: 'Refuser',
    DeclineParagraph1:
      "Si vous refusez cette attestation, vous devrez recommencer le processus afin d'en recevoir une nouvelle en communiquant avec l’organisation qui vous l’a émise. De plus, si une organisation l’exige, l’accès à certains services pourrait être impossible.",
  ...
  ConnectionAlert: {
    ...
    NotificationBody2: ' dans mes contacts. Cette action est nécessaire pour recevoir les services offerts par ',
    NotificationBodyWithoutIssuer:
      "En acceptant l'attestation, je consens à l'ajout d'un nouveau contact. Cette action est nécessaire pour recevoir les services offerts par celui-ci.",
    PopupIntro:
      " Lorsque vous balayez le code QR d'une organisation, celle-ci devient automatiquement un nouveau contact dans votre application. Cette action est nécessaire afin de :",
    ...
    SettingsInstruction2: ' dans la section Plus de votre portefeuille.',
  ...
  ProofRequest: {
    ...
    DeclineBulletPoint2:
      "Afin de recevoir à nouveau la demande de preuve, vous devrez recommencer le processus en communiquant avec l'organisation  qui l’a émise.",
