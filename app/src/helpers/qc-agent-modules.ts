...
export type BCAgent = Agent<ReturnType<typeof getQCAgentModules>>

interface GetQCAgentModulesOptions {
 ...
 */
export function getQCAgentModules({
  indyNetworks,
